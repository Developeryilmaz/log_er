...
class Log {
  ...
  /// ```
  static void debug(String message) => _log(message, '🔹 DEBUG', '\x1B[36m', '\x1B[36m');
  ...
  /// ```
  static void fatal(String message) => _log(message, '💀 FATAL', '\x1B[41m', '\x1B[31m');
  ...
  /// ```
  static void error(String message) => _log(message, '❌ ERROR', '\x1B[31m', '\x1B[31m');
  ...
  /// ```
  static void json(String jsonMessage) => _log(jsonMessage, '🍺 JSON', '\x1B[32m', '\x1B[32m');
  ...
  /// ```
  static void info(String message) => _log(message, '✅ INFO', '\x1B[34m', '\x1B[34m');
  ...
  /// ```
  static void warning(String message) => _log(message, '🚨 WARNING', '\x1B[33m', '\x1B[33m');
  ...
  /// ```
  static void red(String message) => _log(message, '🔴 RED', '\x1B[31m', '\x1B[31m');
  ...
  /// ```
  static void green(String message) => _log(message, '🟢 GREEN', '\x1B[32m', '\x1B[32m');
  ...
  /// ```
  static void yellow(String message) => _log(message, '🟡 YELLOW', '\x1B[33m', '\x1B[33m');
  ...
  /// ```
  static void blue(String message) => _log(message, '🔵 BLUE', '\x1B[34m', '\x1B[34m');
  ...
  /// ```
  static void cyan(String message) => _log(message, '🟦 CYAN', '\x1B[36m', '\x1B[36m');
  ...
  /// ```
  static void magenta(String message) => _log(message, '🟣 MAGENTA', '\x1B[35m', '\x1B[35m');
  ...
  static void _log(String message, String logType, String titleColor, String messageColor) {
    ...
    int lineWidth = message.contains("\n") || messageWidth > terminalWidth ? terminalWidth : messageWidth;
    ...
    print('$titleColor║ $messageColor $message$resetColor'.padRight(lineWidth));
    print('$messageColor║$resetColor');
